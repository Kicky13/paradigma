...
var last = [];
var hei = '';
var url_src1 = "http://par4digma.semenindonesia.com/";
function bahan_data(bulan, opco, yearnow, plant) {
    ...
    //     bulan='0'+bulan
    // }
    $.post(url_src1+'api/index.php/c_coalstock/get_data_bahan?plant=' + plant + '&opco=' + opco + '&tahun=' + yearnow + '&bulan=' + bulan, function (data) {
        // $.post(url_src1+'/api/index.php/cost_report/get_data?date='+yearnow+'.'+bulan+param, function(data){
        ...
        var tgl = dataJson.act_stok[1600].tgl;
		...
		var bco_stok = Number(dataJson.last[2600].qty_stok);
        var bco_ua = Number(dataJson.stok[2600].stok);
        var bco_din2 = Number(dataJson.stok[2600].stok);
        var bco_din = Math.ceil(bt_stok / bt_din2);
        var bco_min = Number(dataJson.maxmin[2600].min);
        var bco_max = Number(dataJson.maxmin[2600].max);
        var bco_rp = Number(dataJson.maxmin[2600].rp);
...
*/
        ...
        var bco_progpkai = Number(dataJson.prog_pakai[2600].prog_use);
        var cp_progpkai = Number(dataJson.prog_pakai[1100].prog_use);
        var sr_progpkai = Number(dataJson.prog_pakai[2100].prog_use);
        var gy_progpkai = Number(dataJson.prog_pakai[2200].prog_use);
        

        $('#bb_prog').html(setFormat(bb_progpkai, 0));
        $('#bt_prog').html(setFormat(bt_progpkai, 0));
        $('#bco_prog').html(setFormat(bco_progpkai, 0));
        $('#cp_prog').html(setFormat(cp_progpkai, 0));
        $('#sr_prog').html(setFormat(sr_progpkai, 0));
        $('#gy_prog').html(setFormat(gy_progpkai, 0));
...
*/
		...
		$('#bco_stok').html(setFormat(bco_stok, 0));
        $('#bco_ua').html(setFormat(bco_ua, 0));
        $('#bco_din').html(Math.ceil(bco_din));
        $('#bco_min').html(setFormat(bco_min, 0));
        $('#bco_max').html(setFormat(bco_max, 0));
        $('#bco_rp').html(setFormat(bco_rp, 0));
...
*/
       if ( bb_stok <= bb_min){
		...
		if ( bco_stok <= bco_min){
            $('#bco_sd').addClass('redmm');
            $('#bco_sd').removeClass('ylmm');
            $('#bco_sd').removeClass('grmm');
            $('#bco_sd').removeClass('blmm');
            $('#bco_bt').addClass('rdbt');
            $('#bco_bt').removeClass('grbt');
            $('#bco_bt').removeClass('ylbt');
            $('#bco_bt').removeClass('blbt');
        }else if ( bco_stok > bco_max) {
            $('#bco_sd').addClass('blmm');
            $('#bco_sd').removeClass('ylmm');
            $('#bco_sd').removeClass('grmm');
            $('#bco_sd').removeClass('redmm');
            $('#bco_bt').addClass('blbt');
            $('#bco_bt').removeClass('grbt');
            $('#bco_bt').removeClass('ylbt');
            $('#bco_bt').removeClass('rdbt');
        }else if ( bco_stok > bco_min && bco_stok < bco_max) {
            $('#bco_sd').addClass('grmm');
            $('#bco_sd').removeClass('ylmm');
            $('#bco_sd').removeClass('blmm');
            $('#bco_sd').removeClass('redmm');
            $('#bco_bt').addClass('grbt');
            $('#bco_bt').removeClass('blbt');
            $('#bco_bt').removeClass('ylbt');
            $('#bco_bt').removeClass('rdbt');
        }else if ( bco_stok <= bco_rp) {
            $('#bco_sd').addClass('ylmm');
            $('#bco_sd').removeClass('grmm');
            $('#bco_sd').removeClass('blmm');
            $('#bco_sd').removeClass('redmm');
            $('#bco_bt').addClass('ylbt');
            $('#bco_bt').removeClass('blbt');
            $('#bco_bt').removeClass('grbt');
            $('#bco_bt').removeClass('rdbt');
        }
...
function bahan_data_detail_gy(bulan, opco, yearnow, type, plant) {
    ...
    // $.post(url_src1+'/api/index.php/Project', function(data){
    // $.post(url_src1+'par4digma/api/index.php/balance?bulan='+bulan+param, function(data){
    //============================================================
    var label = [];
    var terima = [];
    var pakai = [];
    ...
    // }
    var index = [];
    $.get(url_src1+'api/index.php/c_coalstock/get_bahan_chart?material=' + type + '&plant=' + plant + '&opco=' + opco + '&tahun=' + yearnow + '&bulan=' + bulan, function (data) {
    ...
    //============================================================
    var dataJson;
    $.get(url_src1+'api/index.php/c_coalstock/get_data_bahan?plant=' + plant + '&opco=' + opco + '&tahun=' + yearnow + '&bulan=' + bulan, function (data) {
...
// production_cost
        ...
        // var pz_prog_us = '';
        var pz_progpkai = Number(dataJson.prog_pakai[2300].prog_use);
        $('#pz_prog').html(setFormat(pz_progpkai, 0));
        // var pz_min = Number(dataJson.maxmin[2300].min);
        // var pz_max = Number(dataJson.maxmin[2300].max);
        // var pz_rp = Number(dataJson.maxmin[2300].rp);
...
function bahan_data_detail_bco(bulan, opco, yearnow, type, plant) {
    run_waitMe('.wrapper', 'ios');
    console.log(yearnow);
    // console.log(bulan);
    // var param = (opco!='SMI')?'&company='+opco:'';
    ...
    $.post(url_src1+'api/index.php/c_coalstock/get_data_bahan?plant=' + plant + '&opco=' + opco + '&tahun=' + yearnow + '&bulan=' + bulan, function (data) {
        ...
        if (dataJson.rkap == 0) {
                ...
                var bco_rkap_us = Number(dataJson.rkap[2600].rkap);
            }
...
// production_cost
        ...
        var bco_ua = Number(dataJson.stok[2600].stok);
        var bco_din2 = Number(dataJson.stok[2600].stok);
        var bco_din = Math.ceil(bco_stok / bco_din2);
        var bco_real_rc = Number(dataJson.data[2600].terima);
        var bco_real_us = Number(dataJson.data[2600].pakai);
        ...
        $('#bco_stok').html(setFormat(bco_stok, 0));
        $('#bco_ua').html(setFormat(bco_ua, 0));
        $('#bco_din').html(bco_din);
        $('#bco_real_rc').html(setFormat(bco_real_rc, 0));
        $('#bco_real_us').html(setFormat(bco_real_us, 0));
        $('#bco_rkap_us').html(setFormat(bco_rkap_us, 0));
        $('#bco_min').html(setFormat(bco_min, 0));
        $('#bco_max').html(setFormat(bco_max, 0));
        $('#bco_rp').html(setFormat(bco_rp, 0));
...
// production_cost
        ...
        // var cy_prog_us = '';
        var cy_progpkai = Number(dataJson.prog_pakai[2400].prog_use);
$('#cy_prog').html(setFormat(cy_progpkai, 0));
        var cy_min = Number(dataJson.maxmin[2400].min);
        var cy_max = Number(dataJson.maxmin[2400].max);
        var cy_rp = Number(dataJson.maxmin[2400].rp);
...
function nextPage(company, bulan, tahun, type, plant) {
    ...
    window.location.href = "scm_ms_bahan_" + type + ".html";
}
...
// 	data['4000'] = [];
// 	var total = 0;
// 	var urlsmi = url_src1+'/api/index.php/cost_report/get_data?date='+yearnow+'.'+bulan+'&company=smi';
// 	var url3000 = url_src1+'/api/index.php/cost_report/get_data?date='+yearnow+'.'+bulan+'&company=3000';
// 	var url4000 = url_src1+'/api/index.php/cost_report/get_data?date='+yearnow+'.'+bulan+'&company=4000';
// 	var url7000 = url_src1+'/api/index.php/cost_report/get_data?date='+yearnow+'.'+bulan+'&company=7000';
// 	var opco = [];
// 	// alert('haha');
