...
function bahan_data(bulan, opco, yearnow, plant) {
    ...
    $.post(url_src1+'api/index.php/c_coalstock/get_data_bahan?plant=' + plant + '&opco=' + opco + '&tahun=' + yearnow + '&bulan=' + bulan, function (data) {
        ...
        var fa_stok = Number(dataJson.last[1800].qty_stok);
        var fa_ua = Number(dataJson.stok[1800].stok);
        var fa_din2 = Number(dataJson.stok[1800].stok);
        var fa_din = Math.ceil(fa_stok / fa_din2);
        var fa_min = Number(dataJson.maxmin[1800].min);
        var fa_max = Number(dataJson.maxmin[1800].max);
        var fa_rp = Number(dataJson.maxmin[1800].rp);
        ...
        var fa_progpkai = Number(dataJson.prog_pakai[1800].prog_use);
...
// TOTAL #################################################################################################################
        ...
        $('#fa_prog').html(setFormat(fa_progpkai, 0));
        ...
        $('#fa_stok').html(setFormat(fa_stok, 0));
        $('#fa_ua').html(setFormat(fa_ua, 0));
        $('#fa_din').html(Math.ceil(fa_din));
        $('#fa_min').html(setFormat(fa_min, 0));
        $('#fa_max').html(setFormat(fa_max, 0));
        $('#fa_rp').html(setFormat(fa_rp, 0));
...
// TOTAL #################################################################################################################
       ...
       if ( bb_stok <= bb_min){
        ...
        if ( fa_stok <= fa_min){
            $('#fa_sd').addClass('redmm');
            $('#fa_sd').removeClass('ylmm');
            $('#fa_sd').removeClass('grmm');
            $('#fa_sd').removeClass('blmm');
            $('#fa_bt').addClass('rdbt');
            $('#fa_bt').removeClass('grbt');
            $('#fa_bt').removeClass('ylbt');
            $('#fa_bt').removeClass('blbt');
        }else if ( fa_stok > fa_max) {
            $('#fa_sd').addClass('blmm');
            $('#fa_sd').removeClass('ylmm');
            $('#fa_sd').removeClass('grmm');
            $('#fa_sd').removeClass('redmm');
            $('#fa_bt').addClass('blbt');
            $('#fa_bt').removeClass('grbt');
            $('#fa_bt').removeClass('ylbt');
            $('#fa_bt').removeClass('rdbt');
        }else if ( fa_stok > fa_min && fa_stok < fa_max) {
            $('#fa_sd').addClass('grmm');
            $('#fa_sd').removeClass('ylmm');
            $('#fa_sd').removeClass('blmm');
            $('#fa_sd').removeClass('redmm');
...
function bahan_data_detail_fa(bulan, opco, yearnow, type, plant) {
    run_waitMe('.wrapper', 'ios');
    console.log(yearnow);
    // console.log(bulan);
    // var param = (opco!='SMI')?'&company='+opco:'';
    ...
    $.post(url_src1+'api/index.php/c_coalstock/get_data_bahan?plant=' + plant + '&opco=' + opco + '&tahun=' + yearnow + '&bulan=' + bulan, function (data) {
        ...
        if (dataJson.rkap == 0) {
                ...
                var fa_rkap_us = Number(dataJson.rkap[1800].rkap);
            }
...
// production_cost
        ...
        var fa_ua = Number(dataJson.stok[1800].stok);
        var fa_din2 = Number(dataJson.stok[1800].stok);
        console.log('iniee >'+fa_din2);
        if (fa_din2 = '0') {
            var fa_din = 0
             console.log('betul >'+fa_din);
        } else{
            var fa_din = Math.ceil(fa_stok / fa_din2);
        }

        console.log('else >'+fa_din);
        var fa_real_rc = Number(dataJson.data[1800].terima);
        var fa_real_us = Number(dataJson.data[1800].pakai);
        ...
        $('#fa_ua').html(setFormat(fa_ua, 0));
        $('#fa_din').html(fa_din);
        $('#fa_real_rc').html(setFormat(fa_real_rc, 0));
        $('#fa_real_us').html(setFormat(fa_real_us, 0));
        $('#fa_rkap_us').html(setFormat(fa_rkap_us, 0));
        $('#fa_min').html(setFormat(fa_min, 0));
        $('#fa_max').html(setFormat(fa_max, 0));
        $('#fa_rp').html(setFormat(fa_rp, 0));
...
// production_cost
       ...
       var tgl = dataJson.last[2100].update;
        // var sr_prog_us = '';
        var sr_progpkai = Number(dataJson.prog_pakai[2100].prog_use);
        $('#sr_prog').html(setFormat(sr_progpkai, 0));
        var sr_min = Number(dataJson.maxmin[2100].min);
