...
function viewAll(dataStRkap, dataStReal){
	...
	$('#up_prognosa').html(numberWithCommas(dataMonthRkap.PROGNOSA));
	$('#up_rkap').html(numberWithCommas(dataMonthRkap.RKAP));
	$('#up_real').html(numberWithCommas(dataMonthReal.REAL));
