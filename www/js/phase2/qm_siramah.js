...
function action_list(datas, date){
	...
	for(var i=0; i<datas.length; i++) {
		...
		tmp += '<a href="quality_siramah_detail.html#'+datas[i].opco+'/'+date+'" style="border-top:5px solid '+datas[i].color+'">'
...
function opcoGroup (selmonth, selyear){
	...
	$.ajax({
		url: 'http://par4digma.semenindonesia.com/api2/index.php/Par4digma/global_report?date='+date,
		type: "get",
		dataType: "json",
