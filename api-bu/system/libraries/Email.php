...
class CI_Email {
	...
	var	$smtp_host		= "webmail1.semenindonesia.com";		// SMTP Server.  Example: mail.earthlink.net
	var	$smtp_user		= "admin.par4digma@semenindonesia.com";		// SMTP Username
	var	$smtp_pass		= "Indonesia16#";		// SMTP Password
