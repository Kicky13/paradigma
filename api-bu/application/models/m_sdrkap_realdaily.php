...
class M_sdrkap_realdaily extends CI_Model {

    public function get_sdrkap_realdaily()
    {
...
/* End of file m_sdrkap_realdaily.php */
/* Location: ./application/models/m_sdrkap_realdaily.php */