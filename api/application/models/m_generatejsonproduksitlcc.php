...
class M_generatejsonproduksitlcc extends CI_Model {

	public function get_generatejsonproduksitlcc()
	{
...
$query = $db->query("select * from v_plg_tlcc_report where opdate BETWEEN to_date('".$tahun."-".$bulan."-01','YYYY-MM-DD') AND to_date('".$tahun."-".$bulan."-31','YYYY-MM-DD') $wPlant order by opdate asc");
...
/* End of file m_generatejsonproduksitlcc.php */
/* Location: ./application/models/m_generatejsonproduksitlcc.php */