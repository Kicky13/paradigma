...
class m_role extends CI_Model {
    ...
    function getListKaryawan(){
        ...
        $Query = $db->query("SELECT USERNAME, NAME, NOPEG, MENU_LEVEL FROM PAR4_USERLIST ORDER BY USERNAME");
    ...
    function getHeaderUser(){
        ...
        $Query = $db->query("SELECT
                            ...
                            AND column_name NOT IN ('ESELON', 'JABATAN', 'OPCO', 'EMAIL', 'ACTIVE_PAR', 'ACTIVE_BOD', 'VISIT_PAR', 'VISIT_BOD', 'LDAP_FLAG', 'PASSWD')");
        $Data = $Query->result_array();
        return $Data;
    }
