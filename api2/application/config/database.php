...
$db['default5']['hostname'] = '10.15.5.101/devsgg';
$db['default5']['username'] = 'DEVSD';
$db['default5']['password'] = 'gresik45';
...
$db['default8']['hostname'] = '(DESCRIPTION=(ADDRESS=(PROTOCOL=TCP)(HOST=10.15.5.96)(PORT=1521))(CONNECT_DATA=(SID=sgg)))';
$db['default8']['username'] = 'pusb';
$db['default8']['password'] = 'S3M3n6res1k';
$db['default8']['database'] = '';
$db['default8']['dbdriver'] = 'oci8';
$db['default8']['dbprefix'] = '';
$db['default8']['pconnect'] = FALSE;
