...
class M_scodatagen extends CI_Model {

    public function get_scodatagen()
    {
        $db=$this->load->database('default5',true);
        $orgv = 7000;
$tahun = 2016;
$bulan = 09;
$sql = $db->query("SELECT * FROM (select 7000 as company, tbm1.*,tbm2.NM_PROV,tbm2.NM_PROV_1,tbm2.ID_REGION,tbm2.URUT_BARU  from (
...
/* End of file m_scodatagen.php */
/* Location: ./application/models/m_scodatagen.php */