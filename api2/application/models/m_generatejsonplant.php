...
class M_generatejsonplant extends CI_Model {

	public function get_generatejsonplant()
	{
							...
							(
								...
								FROM
									(
										...
										WHERE
											FLAG = 1
										AND (PISJSON IS NOT NULL and PISJSON not in('KL1_Tuban_EP','RM1_Tuban_EP','KL2_Tuban_EP','RM2_Tuban_EP'))
										GROUP BY
											PNTID,
											SORT,
											LOCATION,
...
/* End of file m_generatejsonplant.php */
/* Location: ./application/models/m_generatejsonplant.php */