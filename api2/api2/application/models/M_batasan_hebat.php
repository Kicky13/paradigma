...
class M_batasan_hebat extends DB_QM {

	/** Private Var for datatable **/
    private $post  = array();
	private $table = "M_BATASAN_HEBAT";
	private $pKey  = "ID_BATASAN";
	private $column_order = array(NULL, 'ID_BATASAN','BATASAN'); //set column for datatable order
    private $column_search = array('ASPEK', 'KRITERIA', 'BOBOT', 'BATASAN'); //set column for datatable search 
    private $order = array("ID_BATASAN" => 'ASC'); //default order
	...
	/** Fetch table **/
	public function get(){
		$this->db->select('a.ID_BATASAN, a.ID_KRITERIA, a.BATASAN, b.ID_ASPEK, b.KRITERIA, b.BOBOT, c. ASPEK');
		$this->db->from($this->table . ' a');
		$this->db->join('M_KRITERIA_HEBAT b', 'a.ID_KRITERIA = b.ID_KRITERIA', 'left');
		$this->db->join('M_ASPEK_HEBAT c', 'b.ID_ASPEK = c.ID_ASPEK', 'left');
	}
	...
	/* End of file M_batasan_hebat.php */
	/* Location: ./application/models/M_batasan_hebat.php */
?>