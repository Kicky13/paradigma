...
class M_aspek_hebat extends DB_QM {

	/** Private Var for datatable **/
    private $post  = array();
	private $table = "M_ASPEK_HEBAT";
	private $pKey  = "ID_ASPEK";
	private $column_order = array(NULL, 'ID_ASPEK','ASPEK'); //set column for datatable order
    private $column_search = array('ID_ASPEK', 'ASPEK'); //set column for datatable search 
	...
	/* End of file M_aspek_hebat.php */
	/* Location: ./application/models/M_aspek_hebat.php */
?>