...
class D_production_hourly extends DB_QM {

	/** Private Var for datatable **/
    private $post  = array();
	private $table = "D_PRODUCTION_HOURLY";
	private $pKey  = "ID_PRODUCTION_HOURLY";
	private $column_order = array(NULL, 'ID_PRODUCTION_HOURLY','ID_COMPONENT','NILAI', 'NO_FIELD'); //set column for datatable order
    private $column_search = array('ID_COMPONENT','NILAI', 'ID_PRODUCTION_HOURLY'); //set column for datatable search 
