...
class D_cement_daily extends DB_QM {

	/** Private Var for datatable **/
    private $post  = array();
	private $table = "D_CEMENT_DAILY";
	private $pKey  = "ID_CEMENT_DAILY";
	private $column_order = array(NULL, 'ID_CEMENT_DAILY','ID_COMPONENT','NILAI', 'NO_FIELD'); //set column for datatable order
    private $column_search = array('ID_COMPONENT','NILAI', 'ID_CEMENT_DAILY'); //set column for datatable search 
