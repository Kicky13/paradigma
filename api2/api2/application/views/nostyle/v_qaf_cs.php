<div class="col-sm-6 col-sm-12">
	<div class="box-body table-responsive no-padding">
		...
		<TH  COLSPAN="<?PHP echo count($this->list_component) ?>">COMPRESSIVE STRENGTH (<?php echo $this->NM_PRODUCT ?>)</TH>
		</tr>					
		<tr>
		...
		<tr id='trtotal'>
			<td>QAF TOTAL</td>
			<TD COLSPAN="<?PHP echo count($this->list_component) ?>"><?php echo @round((float)(int)$total/(float)(int)count($this->list_component),2) ?></TD>
		</tr>
		</table>
	</div>
</div>
