...
<script>
  $(document).ready(function(){
    ...
    $('button[name=save]').click(function () {
      ...
      $.ajax({
        url: "<?php echo site_url("input_qaf/save_table");?>",
    ...
    $("#btLoad").click(function(event){
      ...
      $.getJSON('<?php echo site_url("input_qaf/ajax_get_product/");?>' + $("#ID_AREA").val() +"/"+ $("#ID_PLANT").val() +"/"+$("#ID_COMPANY").val(), function (result) {
        cols = [];
        ...
        //Load handsonData
        $.ajax({
          url: "<?php echo site_url("input_qaf/load_table");?>",
