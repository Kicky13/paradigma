  ...
  <div class="row">
    ...
    <div class="col-md-12">
      ...
      <div class="box box-primary">
        ...
        <!-- /.box-header -->
        <!-- form start -->
        <form role="form" method="POST" action="<?php echo site_url("indikator/update") ?>" >
          <div class="box-body" style="background-color:#FFFAAE;">
            ...
            <div class="form-group">
              <div class="col-sm-4 clearfix">
                ...
                <textarea name="CATATAN" type="number" class="form-control" id="CATATAN"><?php echo $this->LIST->CATATAN;?></textarea>
              </div>
            </div>
