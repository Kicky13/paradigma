...
<script>
  $(document).ready(function(){
    ...
    $('button[name=save]').click(function () {
      ...
      $.ajax({
        url: "<?php echo site_url("input_area_hourly/save_table");?>",
    ...
    $("#btLoad").click(function(event){
      ...
      $.getJSON('<?php echo site_url("input_area_hourly/ajax_get_component/");?>' + $("#ID_PLANT").val() +"/"+$("#ID_GROUPAREA").val(), function (result) {
        cols = [];
        ...
        //Load handsonData
        $.ajax({
          url: "<?php echo site_url("input_area_hourly/load_table");?>",
