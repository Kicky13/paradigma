                  ...
                  <div class="box-header">
                    <form class="form-inline">
                      ...
                      <div class="input-group input-group-sm" style="width: 150px; ">
                        <a href="<?php echo site_url("usergroup/add");?>" type="button" class="btn btn-block btn-primary btn-sm">Create New</a>
                      </div>
                      <?PHP endif; ?>
                    </form>
                    <hr/>
...
$(document).ready(function(){
  ...
  var table = $("#dt_tables").DataTable({
      ...
      "serverSide": true,
      "ajax": {
      "url" : '<?php echo site_url("usergroup/get_list");?>',
      "type": 'post',
      "data": function(data){
          //data.usergroup = $("#ID_COMPANY").val();
        }
      },
      "columnDefs": [{
        "targets": 0,
    ...
    $(document).on('click',".btEdit",function () {
      ...
      var url = '<?php echo site_url("usergroup/edit/");?>' + data[0];
    ...
    $(document).on('click',".btDelete",function () {
      var data = table.row($(this).parents('tr')).data();
      var url = '<?php echo site_url("usergroup/delete/");?>' + data[0];

      $.confirm({
          title: "Remove Company",
          text: "This usergroup will be removed. Are you sure?",
          confirmButton: "Remove",
          confirmButtonClass: "btn-danger",
          cancelButton: "Cancel",
          confirm: function() {
