            ...
            <div class="box-header">
	          ...
	          <?php if($this->PERM_WRITE): ?>
	            <div class="input-group input-group-sm" style="width: 150px; ">
	              <a href="<?php echo site_url("product/add");?>" type="button" class="btn btn-block btn-primary btn-sm">Create New</a>
	            </div>
	          <?PHP endif; ?>
	          </form>
          	  <hr/>
...
$(document).ready(function(){
    ...
    $(document).on('click',".btEdit",function () {
      ...
      var url = '<?php echo site_url("product/edit/");?>' + data[0];
    ...
    $(document).on('click',".btDelete",function () {
      var data = table.row($(this).parents('tr')).data();
      var url = '<?php echo site_url("product/delete/");?>' + data[0];

      $.confirm({
          title: "Remove Product",
          text: "This product will be removed. Are you sure?",
