                  ...
                  <div class="box-header">
                    <form class="form-inline">
	                    <div class="form-group">
							<select id="company" <?php if($this->USER->ID_COMPANY){ ECHO "READONLY DISABLED"; } ?> class="form-control select2">
                      ...
                      <div class="input-group input-group-sm" style="width: 150px; ">
                        <a id="btAdd" href="<?php echo site_url("plant/add");?>" type="button" class="btn btn-block btn-primary btn-sm">Create New</a>
                      </div>
                      <?PHP endif; ?>
                    </form>
                    <hr/>
...
$(document).ready(function(){
  ...
  var table = $("#dt_tables").DataTable({
      ...
      "serverSide": true,
      "ajax": {
      "url" : '<?php echo site_url("plant/get_list");?>',
      "type": 'post',
      "data": function(data){
    ...
    $(document).on('click',".btEdit",function () {
      ...
      var url = '<?php echo site_url("plant/edit/");?>' + data[0];
    ...
    $(document).on('click',".btDelete",function () {
      var data = table.row($(this).parents('tr')).data();
      var url = '<?php echo site_url("plant/delete/");?>' + data[0];

      $.confirm({
          title: "Remove Company",
          text: "This plant will be removed. Are you sure?",
          confirmButton: "Remove",
          confirmButtonClass: "btn-danger",
          cancelButton: "Cancel",
          confirm: function() {
