            ...
            <div class="box-header">
	          ...
	          <?php if($this->PERM_WRITE): ?>
	            <div class="input-group input-group-sm" style="width: 150px; ">
	              <a href="<?php echo site_url("grouparea/add");?>" type="button" class="btn btn-block btn-primary btn-sm">Create New</a>
	            </div>
	          <?PHP endif; ?>
	          </form>
          	  <hr/>
...
$(document).ready(function(){
	...
	/** DataTables Init **/
      ...
      "serverSide": true,
      "ajax": {
      "url" : '<?php echo site_url("grouparea/get_list");?>',
      "type": 'post',
      "data": function(data){
    ...
    $(document).on('click',".btEdit",function () {
      ...
      var url = '<?php echo site_url("grouparea/edit/");?>' + data[0];
    ...
    $(document).on('click',".btDelete",function () {
      var data = table.row($(this).parents('tr')).data();
      var url = '<?php echo site_url("grouparea/delete/");?>' + data[0];

      $.confirm({
          title: "Remove Group Area",
          text: "This grouparea will be removed. Are you sure?",
