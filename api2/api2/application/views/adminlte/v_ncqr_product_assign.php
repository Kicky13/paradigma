   <!-- Content Header (Page header) -->
    ...
    <section class="content">
       ...
       <div class="row">
		...
		<form class="form-horizontal" method="post" action="<?php echo site_url("ncqr_product/create") ?>" >
          ...
          <div class="box">
            ...
            <div class="box-footer">
                ...
                <button type="button" class="btn btn-normal" onclick="document.location.href='<?php echo site_url("ncqr_product") ?>';" >Cancel</button>
...
$(document).ready(function(){
	...
	$("#ID_PLANT").change(function(){
		...
		var url = "<?php echo site_url("ncqr_product/ncqr_grouparea/") ?>";
		$.getJSON(url,function(data){
			$("#ID_GROUPAREA").empty();
			data.forEach(function(r){
	...
	$("#ID_GROUPAREA").change(function(){
		var url = "<?php echo site_url("ncqr_product/async_configuration/") ?>"+$("#ID_PLANT").val()+"/"+this.value;
		console.log(url);
		$.getJSON(url,function(data){
