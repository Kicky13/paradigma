          ...
          <div class="box">
            ...
            <?php if($this->PERM_WRITE): ?>
              <div class="input-group input-group-sm" style="width: 150px; ">
                <a href="<?php echo site_url("machinestatus/add");?>" type="button" class="btn btn-block btn-primary btn-sm">Create New</a>
              </div>
            <?PHP endif; ?>
            </form>
              <hr/>
...
$(document).ready(function(){
  /** DataTables Init **/
      ...
      "serverSide": true,
      "ajax": {
      "url" : '<?php echo site_url("machinestatus/get_list");?>',
      "type": 'post',
      "data": function(data){
    ...
    $(document).on('click',".btEdit",function () {
      ...
      var url = '<?php echo site_url("machinestatus/edit/");?>' + data[0];
    ...
    $(document).on('click',".btDelete",function () {
      var data = table.row($(this).parents('tr')).data();
      var url = '<?php echo site_url("machinestatus/delete/");?>' + data[0];

      $.confirm({
          title: "Remove Machine Status",
          text: "This machinestatus will be removed. Are you sure?",
