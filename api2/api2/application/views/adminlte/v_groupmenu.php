                  ...
                  <div class="box-header">
                    <form class="form-inline">
                      ...
                      <div class="input-group input-group-sm" style="width: 150px; ">
                        <a href="<?php echo site_url("groupmenu/add");?>" type="button" class="btn btn-block btn-primary btn-sm">Create New</a>
                      </div>
                      <?PHP endif; ?>
                    </form>
                    <hr/>
...
$(document).ready(function(){
  ...
  var table = $("#dt_tables").DataTable({
    ...
    $(document).on('click',".btEdit",function () {
      ...
      var url = '<?php echo site_url("groupmenu/edit/");?>' + data[0];
    ...
    $(document).on('click',".btDelete",function () {
      var data = table.row($(this).parents('tr')).data();
      var url = '<?php echo site_url("groupmenu/delete/");?>' + data[0];
