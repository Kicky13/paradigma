            ...
            <div class="box-body table-responsive no-padding">
              <table class="table-fixed table-hover">
                ...
                <tr>
				  ...
				  <td><?php echo $incident->JUDUL_SOLUTION ?></td>
                  <td> 
						<a type="button" class="btn btn-success btn-xs" href="<?php echo site_url("incident/solved/".$incident->ID_INCIDENT) ?>">View Detail</a>
