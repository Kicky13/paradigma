        ...
        <div class="box-header">
          <form class="form-inline">
            <div class="input-group input-group-sm" style="width: 150px; ">
              <a href="<?php echo site_url("indikator/add");?>" type="button" class="btn btn-block btn-primary btn-sm">Create New</a>
            </div>
          </form>
          <hr/>
        </div>
...
<script>
    $(document).ready(function(){
      ...
      "serverSide": true,
      "ajax": {
      "url" : '<?php echo site_url("indikator/get_list");?>',
      "type": 'post',
      "data": function(data){
    ...
    $(document).on('click',".btEdit",function () {
      var url = '<?php echo site_url("indikator/edit");?>';
    ...
    $(document).on('click',".btDelete",function () {
      var url = '<?php echo site_url("indikator/remove");?>';
      var data = table.row($(this).parents('tr')).data();
      var id_indikator = data[0];
