...
<script>
  $(document).ready(function(){
    ...
    $('button[name=save]').click(function () {
      ...
      $.ajax({
        url: "<?php echo site_url("input_cement_daily/save_table");?>",
    ...
    $("#ID_AREA").change(function(){
      ...
      $.getJSON('<?php echo site_url("input_cement_daily/ajax_get_product/");?>' + $(this).val() + '/' + $("#ID_PLANT").val() + '/' + $("#ID_COMPANY").val(), function (result) {
        var values = result;
    ...
    $("#btLoad").click(function(event){
      ...
      $.getJSON('<?php echo site_url("input_cement_daily/ajax_get_component/");?>' + $("#ID_PLANT").val() +"/"+$("#ID_GROUPAREA").val(), function (result) {
        cols = [];
        ...
        //Load handsonData
        $.ajax({
          url: "<?php echo site_url("input_cement_daily/load_table");?>",
