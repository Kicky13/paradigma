...
<script>
  $(document).ready(function(){
    ...
    $('button[name=save]').click(function () {
      //var fm = $("#ID_GROUPAREA option:selected").text();
    ...
    function saveCement(argument) {
      ...
      $.ajax({
        url: "<?php echo site_url("input_daily/save_table_cement");?>",
    ...
    function saveTable() {
      ...
      $.ajax({
        url: "<?php echo site_url("input_daily/save_table");?>",
        data: {"data": handsonData, "formData": formData, "id_comp": id_comp}, //returns all cells' data
        dataType: 'json',
        type: 'POST',
        success: function (res) {
    ...
    $("#ID_COMPANY").change(function(){
      ...
      $.getJSON('<?php echo site_url("input_daily/ajax_get_plant/");?>' + company, function (result) {
        var values = result;
    ...
    $("#ID_PLANT").change(function(){
      ...
      $.getJSON('<?php echo site_url("input_daily/ajax_get_grouparea/");?>' + $("#ID_COMPANY").val() + '/' + plant, function (result) {
        var values = result;
    ...
    $("#ID_GROUPAREA").change(function(){
      ...
      $.getJSON('<?php echo site_url("input_daily/ajax_get_area/");?>' + $("#ID_COMPANY").val() + '/' + $("#ID_PLANT").val() + '/' + grouparea, function (result) {
        var values = result;
    ...
    function loadInput() {
      ...
      var hari;
      blTh = blTh.split("/");
      console.log(parseInt(blTh[0])+" - " + <?php echo  (int) date("m");?>);
      if (parseInt(blTh[0]) === <?php echo  (int) date("m");?>) {
        hari = <?php echo (int) date("d");?>;//getNumberOfDays((blTh[0]-1), (blTh[1]));
      }else{
        hari = getNumberOfDays((blTh[0]-1), (blTh[1]));
      }
      ...
      //Load handsonData
      $.ajax({
        url: "<?php echo site_url("input_daily/load_table");?>",
    ...
    function loadCement() {
      ...
      //console.log(parseInt(blTh[0])+" - " + <?php echo  (int) date("m");?> + " + " + hari);
      ...
      //Load handsonData
      $.ajax({
        url: "<?php echo site_url("input_daily/load_cement");?>",
        data: {"formData": formData},
        dataType: 'json',
        type: 'POST',
        success: function (result) {
    ...
    $("#ID_AREA").change(function(){
      ...
      $.getJSON('<?php echo site_url("input_daily/ajax_get_product/");?>' + $(this).val() + '/' + $("#ID_PLANT").val() + '/' + $("#ID_COMPANY").val(), function (result) {
        var values = result;
