		...
		$.get(url,function(data){
			...
			var tr = null;
				data.forEach(function(r){
					...
					tr += "<td>"+((r.KD_PRODUCT)?r.KD_PRODUCT:"-")+"</td>";
					tr += "<td><a type=button class='btn btn-xs btn-success' href='<?php echo site_url("ncqr_range/edit") ?>/"+$("#ID_PLANT").val()+"/"+$("#ID_GROUPAREA").val()+"/"+((r.ID_PRODUCT)?r.ID_PRODUCT:"")+"' >CONFIGURATION</a></td>";
					tr += "</tr>";
					$("#div_table").append(tr);
				});
			}
