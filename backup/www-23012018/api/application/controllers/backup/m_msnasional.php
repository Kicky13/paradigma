...
class M_msnasional extends CI_Model {
	...
	public function get_ms_com2($param){
		$db=$this->load->database('default5',true);
		...
		$sql = "
				...
				LEFT JOIN (
					...
					GROUP BY
						PROPINSI ,KODE_PERUSAHAAN
				) TBL51 ON TBL1.KODE_PERUSAHAAN = TBL5.KODE_PERUSAHAAN AND TBL1.PROPINSI = TBL5.PROPINSI
				LEFT JOIN (
					SELECT
						KODE_PERUSAHAAN,
						PROPINSI,
				...
				AND TBL1.KODE_PERUSAHAAN = TBL9.KODE_PERUSAHAAN
				 ...
				 WHERE tbl1.kode_perusahaan IN ('110', '102', '112')
	...
	public function get_detail_prov($provinsi,$bulan, $tahun){
		$db=$this->load->database('default5',true);
