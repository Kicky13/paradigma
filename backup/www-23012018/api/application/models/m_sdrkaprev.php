...
class M_sdrkaprev extends CI_Model {

    public function get_sdrkaprev()
    {
...
/* End of file m_sdrkaprev.php */
/* Location: ./application/models/m_sdrkaprev.php */