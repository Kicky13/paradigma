$(function () {
    $.ajax({
        url: url_src+'/api/index.php/stokppudang/stokdetails4000',
        type: 'GET',
        success: function (data) {
           ...
           // var data2 = data.replace("(", "[");
            ...
            for (var x=0;x<iArray.length;x++) {
                ...
                labelArray.push(c);
                realisasi_stok = dataJson.Semen[c].realisasi_stok;
                realisasi_prod = dataJson.Semen[c].realisasi_prod;
				min_stok = dataJson.Semen[c].min_stok;
                max_stok = dataJson.Semen[c].max_stok;
				prog_produk = dataJson.Semen[c].prog_produk;
                rkap_produk = dataJson.Semen[c].rkap_produk;
                prog_stok = dataJson.Semen[c].prog_stok;
                console.log(max_stok);
                console.log(typeof(max_stok));
