            ...
            success: function(data){
              ...
              $.each(dataJson.smig, function(i,result){
                  ...
                  if (com == '7000') {
                    ...
                    total_temp += stok;
                    addTableRow('tbstemp', dist, stok, cap, stoklvl);
                    pers_temp +=stoklvl;
                    count_temp +=1;
                  }
                  
              });
              console.log(pers_tl+': sp: '+pers_sp+': st: '+pers_st+': sg: '+pers_sg+': stemp: '+pers_temp);
              stok_level = pers_tl + pers_sp + pers_st + pers_sg + pers_temp;
              count_gudang = (count_tl + count_sg + count_sp + count_st + count_temp)-5;
