         ...
         //$("#cashout").html(parseFloat(cashout).toFixed(2) +' M');
            ...
            for (var x in index){              
                ...
                if (index[x] <= 0) {
                    ...
                    nilaiCompany = dataJson['7000'].finance['2000'][trim].company;
                    nilaiPay = dataJson['7000'].finance['2000'][trim].acc_pay;
                    nilaiRec = dataJson['7000'].finance['2000'][trim].acc_rec;
                    //nilaiTime = dataJson['7000'].finance['2000'][trim].date_time;
                    nilaiDay = dataJson['7000'].finance['2000'][trim].day;
                    ...
                    nilaiPay = dataJson['7000'].finance['2000'][x].acc_pay;
                    nilaiRec = dataJson['7000'].finance['2000'][x].acc_rec;
