...
function highlight(selmonth, selyear){
	...
	var Url = $.getJSON('http://10.15.5.150/dev/par4digma/api/index.php/cash_flow_st?bulan='+selmonth+'&tahun='+selyear, function(data){
...
function graphic_saldo(selmonth, selyear){
		...
		url:'http://10.15.5.150/dev/par4digma/api/index.php/cash_flow_st/saldo_harian?bulan='+selmonth+'&tahun='+selyear,
		type: 'GET',
...
function opcoGroup(selmonth, selyear){
	...
	$.getJSON('http://10.15.5.150/dev/par4digma/api/index.php/cash_flow_st/average?bulan='+selmonth+'&tahun='+selyear,function (data) {
