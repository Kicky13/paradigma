        ...
        dist += '<div class="item_distributor">'
            ...
            dist += '<div class="item_detail">'
                dist += '<div>'
                    ...
                    dist += '<h3>'+setFormat((data[i].qtyonhand*40)/1000)+'</h3>'   
                dist += '</div>'
                dist += '<div>'
                    dist += '<h2>Qty reserved</h2>'
                    dist += '<h3>'+setFormat((data[i].qtyreserved*40)/1000)+'</h3>'   
                dist += '</div>'
                dist += '<div>'
                    dist += '<h2>Qty available</h2>'
                    dist += '<h3>'+setFormat((data[i].qtyavailable*40)/1000)+'</h3>'   
                dist += '</div>'
                dist += '<div>'
                    dist += '<h2>Qty ordered</h2>'
                    dist += '<h3>'+setFormat((data[i].qtyordered*40)/1000)+'</h3>'   
                dist += '</div>'
            dist += '</div>'
        dist += '</div>';
    }
            ...
            group += '<div id="subgroup">'
                ...
                group += '<div class="item_detail">'
                    group += '<div>'
                        ...
                        group += '<h3>'+setFormat((val[j].qtyonhand*40)/1000)+'</h3>'   
                    group += '</div>'
                    group += '<div>'
                        group += '<h2>Qty reserved</h2>'
                        group += '<h3>'+setFormat((val[j].qtyreserved*40)/1000)+'</h3>'   
                    group += '</div>'
                    group += '<div>'
                        group += '<h2>Qty available</h2>'
                        group += '<h3>'+setFormat((val[j].qtyavailable*40)/1000)+'</h3>'   
                    group += '</div>'
                    group += '<div>'
                        group += '<h2>Qty ordered</h2>'
                        group += '<h3>'+setFormat((val[j].qtyordered*40)/1000)+'</h3>'   
                    group += '</div>'
                group += '</div>'
            group += '</div>'
        }
