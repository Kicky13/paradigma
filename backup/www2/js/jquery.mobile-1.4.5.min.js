...
c) {
    ...
    b) {
        ...
        a("<a>").data("a-b",
        "a").removeData("a-b").data("a-b")&&(a.fn.removeData=function(b) {
            return function(c) {
    ...
    b) {
        ...
        ,
        a.find.matchesSelector=function(b,
        c) {
    ...
    b) {
        ...
        d) {
            ...
            f,
            {
                version:d.version, _proto:a.extend( {}, d), _childConstructors: []
            }
            ),
            h=new c,
        ...
        f=function() {
            ...
            b.attachEvent&&!b.addEventListener&&!k&&function() {
                ...
                i.start=function() {
                    ...
                    d||"javascript:0").insertAfter("body")[0].contentWindow,
